...
/**
 * Codeigniter Dynamic Menu Class
 * Provide easy way to render dynamic menu
 * 
 * @package			CodeIgniter
 * @subpackage	Libraries
 * @category		Libraries
 * @author			Dadan Abdullah
 * @link    		https://github.com/dadanabdullah/CodeIgniter-Dynamic-Menu
 */
class Dynamic_menu
{
	...
	/**
	 * load configuration on config/dynamic_menu.php
	 * 
	 * @param array $config 
	 */
	...
	/**
	 * Initialize dynamic menu configuration
	 * 
	 * @param  array  $config dynamic menu configuration
	 * @return void         
	 */
